...
public class GetCurrentPatientList extends AsyncTask<String, String, ArrayList<String>> {
    private static final String LOGIN_URL = "http://kaanakinci.me/B2D/getCurPatients.php";
    ...
    public GetCurrentPatientList(int dId, ProgressDialog p)
    {
        this.dId=dId;
        this.p=p;
